...
public class ItemManager {
    ...
    public boolean shouldSpawnItem(int totalLinesCleared) {
        if (!itemModeEnabled) {
            System.out.println(">>> ItemManager: Item mode is DISABLED");
            return false;
        }
        ...
        if (totalLinesCleared >= lastItemSpawnLines + LINES_FOR_ITEM) {
            ...
            System.out.println(">>> ItemManager: Item should spawn! Total lines: " + totalLinesCleared + ", Last spawn: " + lastItemSpawnLines);
            return true;
        }
        
        System.out.println(">>> ItemManager: Not yet. Total: " + totalLinesCleared + ", Last spawn: " + lastItemSpawnLines + ", Need: " + (lastItemSpawnLines + LINES_FOR_ITEM));
        return false;
    }
    ...
    public Block spawnRandomItem() {
        ...
        switch (itemType) {
            case 0:
                ...
                System.out.println(">>> Item Manager: Spawned SingleBlock item");
                break;
            case 1:
                itemBlock = new weightedBlock();
                System.out.println(">>> Item Manager: Spawned WeightedBlock item");
                break;
            case 2:
